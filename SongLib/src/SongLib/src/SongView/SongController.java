...
public class SongController{
	...
	public void start(Stage mainStage) throws Exception{
		...
		songList = FXCollections.observableArrayList(readFromFile("src/SongView/songs.txt")); //change this when packages made
	      ...
	      mainStage.setOnCloseRequest(event -> {
	    	 ...
	    	 //save songs to songs.txt file
	    	  PrintWriter writer;
	    	  	try {
	    	  			File file = new File ("src/SongView/songs.txt"); //change this when packages made
	    	  			file.createNewFile();
